...
import { Mail, Lock, User, ArrowRight, Loader2, CheckCircle2, Zap, MessageSquare } from "lucide-react";
  ...
  const handleGoogleSignup = async () => {
    ...
    try {
        ...
        toast.success("Account created!", {
            description: "Welcome to NEXLIV. Let's find your perfect place.",
        });
        navigate("/onboarding");
    } catch (error: unknown) {
    ...
    <div className="min-h-screen flex w-full bg-[#fdfbf7] overflow-hidden relative">
      ...
      <div className="flex w-full h-full min-h-screen">
        ...
        <div className="hidden lg:flex w-1/2 flex-col justify-between relative z-10 p-16 bg-[#fdfbf7]">
            <div>
                ...
                >
                    <h1 className="text-6xl font-black text-[#2a0808] mb-6 tracking-tight leading-[1.1]">
                        Join Our <br/>
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#800020] to-orange-600">Community.</span>
                    </h1>
                    <p className="text-xl text-[#2a0808]/60 max-w-md leading-relaxed">
                        Create your account to unlock exclusive listings and connect directly with property owners.
                    </p>
                </motion.div>
            </div>
            ...
            >
                {[
                    { title: "Personalized Feed", desc: "Listings tailored to your preferences.", icon: User },
                    { title: "Instant Applications", desc: "Apply to properties with one click.", icon: Zap },
                    { title: "Direct Chat", desc: "Message owners directly and securely.", icon: MessageSquare }
                ].map((item, i) => (
        ...
        {/* Right Side - Signup Form (Dark Modal) */}
            ...
            >
                <div className="bg-[#500014] p-8 md:p-10 shadow-2xl relative overflow-hidden rounded-sm border border-[#800020]/50">
                    ...
                    <div className="text-center mb-8 relative z-10">
                        <h2 className="text-2xl font-bold text-white mb-2 tracking-wide">NEW REGISTRATION</h2>
                        <div className="h-0.5 w-12 bg-orange-500 mx-auto" />
                    </div>

                    <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                        <div className="space-y-2">
                            <Label htmlFor="name" className="text-white/70 text-xs uppercase tracking-wider ml-1">Full Name</Label>
                            <div className="relative group">
                                <User className="absolute left-4 top-3.5 h-4 w-4 text-white/40 group-focus-within:text-orange-400 transition-colors" />
                                <Input
                                    id="name"
                                    name="name"
                                    type="text"
                        ...
                        <Button 
                            type="submit" 
                            disabled={isLoading}
                            className="w-full h-12 bg-gradient-to-r from-orange-600 to-orange-500 hover:from-orange-500 hover:to-orange-400 text-white font-bold rounded-sm text-sm uppercase tracking-widest transition-all shadow-lg shadow-orange-900/20 hover:shadow-orange-900/40 transform hover:-translate-y-0.5 mt-2"
                        >
                            {isLoading ? (
                    ...
                    <div className="relative my-8 z-10">
                        ...
                        <div className="relative flex justify-center text-xs uppercase">
                            <span className="bg-[#500014] px-4 text-white/40">Or join with</span>
                        </div>
                    </div>
                    ...
                    <div className="mt-8 text-center relative z-10">
                        <p className="text-white/60 text-sm">
                            ...
                            <Link to="/login" className="text-orange-400 hover:text-orange-300 font-bold hover:underline ml-1">
                                Login here
                            </Link>
                        </p>
                    </div>
